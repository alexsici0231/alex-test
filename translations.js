...
const translations = {
  ...
  ro: {
    ...
    metaFeatureLookalike: 'Audiențe Lookalike și Custom',
    metaFeatureFunnels: 'Pâlnii de vânzări pe mai multe niveluri',
    metaFeatureABTest: 'Testarea A/B a creativilor',
    metaFeatureOptimization: 'Optimizare pe conversii și ROAS',
    metaFeatureSetupCabinet: 'Configurare cabinet publicitar',
    metaFeatureTwoCampaigns: '2 campanii publicitare',
    metaFeatureAudienceAnalysis: 'Analiza publicului țintă',
    metaFeatureMonthlyReport: 'Raport lunar',
    metaFeatureAllBasic: 'Tot din planul de bază',
    metaFeatureFiveCampaigns: 'Până la 5 campanii simultane',
    metaFeatureLookalike2: 'Audiențe Lookalike',
    metaFeatureWeeklyReports: 'Rapoarte săptămânale',
    metaFeatureUnlimitedCampaigns: 'Campanii nelimitate',
    metaFeatureAllFromPro: 'Tot din Pro planul',
    metaFeatureDedicatedStrateg: 'Strateg dedicat',
    metaFeaturePriority: 'Suport prioritar 24/7',
    
    // Pricing features (Google)
    googleFeatureSearchDisplay: 'Campanii Search + Display',
    googleFeatureYoutube: 'Publicitate YouTube',
    googleFeaturePerformanceMax: 'Performance Max',
    googleFeatureShoppingRemarketing: 'Shopping și remarketing',
    googleFeatureAllFromBasic: 'Tot din planul de bază',
    googleFeatureConversionSetup: 'Configurare conversii',
    googleFeatureAllCampaignTypes: 'Toate tipurile de campanii',
    googleFeatureYoutubeShopping: 'Publicitate YouTube și Shopping',
    googleFeatureAllFromPro: 'Tot din Pro planul',
    googleFeatureDedicatedStrateg: 'Strateg dedicat',
    googleFeaturePriority: 'Suport prioritar 24/7',
    
    // Pricing features (SMM)
    smmFeatureContentStrategy: 'Strategie de conținut și scenarii',
    smmFeatureReelsProduction: 'Producție Reels și Stories',
    smmFeatureDesign: 'Design și stil vizual',
    smmFeatureCommunityManagement: 'Community management',
    smmFeaturePosts: '8 postări pe lună',
    smmFeatureReels: '3 Reels/Shorts',
    smmFeatureOneSocial: '1 rețea socială',
    smmFeatureAnalytics: 'Analitica de bază',
    smmFeatureTwentySix: '12 postări pe lună',
    smmFeatureFourReels: '5 Reels/Shorts',
    smmFeatureTwoSocial: '2 rețele sociale',
    smmFeatureDaily: 'Stories zilnic',
    smmFeatureUnlimited: 'Conținut nelimitat',
    smmFeatureTwentyPlus: '20+ Reels pe lună',
    smmFeatureAllSocial: 'Toate rețelele sociale',
    smmFeatureInfluencer: 'Colaborări cu influenceri',
    smmFeaturePersonalManager: 'Manager personal',
    
    // AI Video features
    aiVideoHighQuality: 'Videoclipuri AI de înaltă calitate',
    aiVideoFrames: 'Fotorame pentru aprobare înainte de creare',
    aiVideoEdits: 'Până la 3 editsuri incluse',
    aiVideoAdditional: 'Fiecare editură suplimentară — 17€',
    aiVideoVoiceover: 'Voice-over (RO/RU) +50€',
    aiVideoTurnaround: 'Termenul: 1-3 zile de lucru',
    
    // SMM Additional features
    smmPosts10: '10 postări pe lună',
    smmPosts14: '14 postări pe lună',
    smmPosts17: '17 postări pe lună',
    smmPosts20: '20 postări pe lună',
    smmVideosSmartphone4: '4 viduri smartphone',
    smmVideosSmartphone: '4 viduri pe smartphone',
    smmPhotoPosts6: '6 postări foto',
    smmPhotoPosts9: '9 postări foto',
    smmPhotoPosts12: '12 postări foto',
    smmShooting3: '3 filmări pe lună',
    smmShooting5: '5 filmări pe lună',
    smmContentPlanning: 'Planificare conținut',
    smmRepostStories: 'Reposting postări în stories',
    smmBloggerWork: 'Colaborare cu influenceri',
    smmCopywriting: 'Copywriting',
    smmAnalytics1: 'Analitica și raport 1 rețea',
    smmAnalytics2: 'Analitica și raport 2 rețele',
    smmVisualStyle: 'Creare stil vizual',
    smmStories35: 'Insta Stories (35 unice)',
    smmStories40: 'Insta Stories (40 unice)',
    smmVideoProfessional: '1 video profesional (CGI/dronă)',
